...
dht.begin();//starts the standard function which is void setup
}
void loop() {
...
float temperature = dht.readTemperature(); // Temperature in Celsius which is predefined in the library
